...
Baseline_table1 <- Baseline %<>% select(ID,
                     Age,
                     Sex,
                     Education_category,
                     SOS_mnemonic,
...
# Create Table 1
table1 <- CreateTableOne(listVars, Baseline_table1, catVars, strata = c("Sex"))
table1
...
# Save output to txt for Table 1
...
summary <- Baseline %>% summarise(
    mean_age = mean(Age, na.rm = TRUE),
    median_age = median(Age, na.rm = TRUE),
    max_age = max(Age, na.rm = TRUE),
    min_age = min(Age, na.rm = TRUE),
    median_CD4 = median(CD4_uptodate, na.rm = TRUE),
    Q25_CD4 = quantile(CD4_uptodate, 0.25, na.rm = TRUE),
    Q75_CD4 = quantile(CD4_uptodate, 0.75, na.rm = TRUE),
    mean_pss = mean(PSS_BL, na.rm = TRUE),
    sd_pss = sd(PSS_BL, na.rm = TRUE),
    mean_pis = mean(PIS_BL, na.rm = TRUE),
    sd_pis = sd(PIS_BL, na.rm = TRUE),
    mean_bdi = mean(bdi_BL, na.rm = TRUE),
    sd_bdi = sd(bdi_BL, na.rm = TRUE),
    mean_se6 = mean(se6_BL, na.rm = TRUE),
    sd_se6 = sd(se6_BL, na.rm = TRUE),
    sd_eq5dSOH = sd(State_of_health.BL, na.rm = TRUE),
    mean_eq5dindex = mean(eq5d_index_BL, na.rm = TRUE),
    sd_eq5dindex = sd(eq5d_index_BL, na.rm = TRUE)
)
